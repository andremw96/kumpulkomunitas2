            ...
            <div class="box-body">
              ...
              {{csrf_field()}}
                ...
                <div class="form-group">
                   <select name="userid_penerima" class="form-control" placeholder="Penerima">
                ...
                <div>
                  <textarea name="isi" class="textarea" placeholder="Message" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
