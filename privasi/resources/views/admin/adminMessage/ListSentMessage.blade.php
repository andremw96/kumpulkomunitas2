...
@section('title', 'Admin Dashboard | Daftar Pesan Terkirim')
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">List Pesan Terkirim</li>
  </ol> 
</section>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="{{ url('admin/adminmessage/ListSentMessage') }}"><i class="fa fa-envelope-o"></i> Sent</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
	                  ...
	                  <tbody>
	                  	@foreach($message as $Listmessage)
							<tr>
								...
								<td><a href="{{ url('admin/adminmessage/' . $Listmessage->id) }}">{{ $Listmessage->title }}</a></td>
